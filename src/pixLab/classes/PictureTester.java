...
public class PictureTester
{
	...
	public static void testActuallyRandom()
	{
		...
		trees.write("/Users/jnel4175/Pictures/GlitchArt.jpg");
		trees.explore();
		trees.grayscale();
		trees.explore();
	}
	...
	public static void testHearts(boolean doSave)
	{
	...
	{
		Picture moo = new Picture("people.jpg");
		Picture baa = new Picture("spam.jpg");
		moo.merge(baa);
		moo.explore();
	}

	public static void testAddColorText()
	{
		Picture moo = new Picture("arch.jpg");
		moo.addColorMessage("this is a sentence", moo.getAverageColor(), moo.getWidth() / 2, moo.getHeight() / 2);
		moo.explore();
	}
