...
public class SimplePicture implements DigitalPicture
{
	...
	/**
	 * Method to draw a message as a string on the buffered image as a chosen
	 * color
	 * 
	 * @param message
	 *            the message to draw on the buffered image
	 * @param color
	 *            the color of the text being added
	 * @param xPos
	 *            the x coordinate of the leftmost point of the string
	 * @param yPos
	 *            the y coordinate of the bottom of the string
	 */
	public void addColorMessage(String message, Color color, int xPos, int yPos)
	{
		// get a graphics context to use to draw on the buffered image
		Graphics2D graphics2d = bufferedImage.createGraphics();
